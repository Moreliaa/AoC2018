...
this.createBranch(this.index + 1);

return;

case "|":

this.parentPath.createBranch(this.index + 1);

return;

case ")":

this.parentPath.tieNextPathToParent(this.index + 1);

return;

default:

this.path = this.path.concat(c);
...
var key = this.xPos + "," + this.yPos;

if (!areaMap.hasOwnProperty(key) || areaMap[key] > this.steps)

areaMap[key] = this.steps;
...
var newPath = new Path(i, this.xPos, this.yPos, this.steps, this);
...
this.tieNextPathToParent = function (ind) {

var newPath = new Path(ind, this.xPos, this.yPos, this.steps,
this.parentPath);
...
var path = new Path(0, 0, 0, 0, null);
